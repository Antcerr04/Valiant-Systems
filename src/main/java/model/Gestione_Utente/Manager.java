...
public class Manager extends Utente {
     ...
     * @param passwordHash encrypted password of the manager
     */
    public Manager(String nome, String cognome, String username, String password, String email, String passwordHash) {
