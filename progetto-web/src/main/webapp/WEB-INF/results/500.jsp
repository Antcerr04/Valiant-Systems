...
<div class="flex-wrapper">
  ...
  <div style="text-align: center;margin-top: auto;margin-bottom: auto;padding: 50px 0;">
    <span class="material-icons" style="color: #e01721; font-size: 60px">warning</span>
    <h1>Errore 500 - Errore interno del server!</h1>
    <div style="margin-top: 30px">Un problema imprevisto ha impedito al server di soddisfare la tua richiesta. <br>
